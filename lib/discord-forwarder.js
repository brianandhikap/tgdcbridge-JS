...
class DiscordForwarder {
  ...
  async testWebhook(webhookUrl) {
    try {
      const testPayload = {
        username: "Telegram-Discord Forwarder",
        content: "🔗 Connection test successful! The forwarder is working properly.",
        avatar_url: null,
      }
  ...
  async testWebhookWithMessage(webhookUrl, customMessage) {
    try {
      const testPayload = {
        username: "Telegram-Discord Forwarder",
        content: customMessage || "🔗 Connection test successful! The forwarder is working properly.",
        avatar_url: null,
      }
